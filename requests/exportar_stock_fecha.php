...
$fechad= htmlspecialchars(trim($_GET['dFecCre']));
if (!empty($fechad)) {
    $filtros = $filtros . " AND a.ubirefer = '$fechad'";
}
$fechah= htmlspecialchars(trim($_GET['hFecCre']));
if (!empty($fechah)) {
    $filtros = $filtros . " AND a.ubirefer = '$fechah'";
}
