                    ...
                    <div class="row">
                        <?php
                            ...
                            echo '<table class="table">'
                                . '<thead>'
                                    . '<tr>'
                                    . '<th colspan="3">Consulta de Stock por Lotes</th>'
                                    . '</tr>'
                                . '</thead>'
                            . '</table>';?>
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        ...
                                        <div class="input-group">                                            
                                            ...
                                            <span class="input-group-btn">
                                                ...
                                                <button class="btn btn-default" onclick="loadMatchModal('articulo','artrefer,artdesc', 'arti', 1)" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div><!-- /input-group -->
                                    </div><!-- /.col-lg-6 -->
                                    <div class="col-lg-3 col-sm-3">
                                        ...
                                        <div class="input-group">                                            
                                            ...
                                            <span class="input-group-btn">
                                                <!--poner siempre la columna clave primero cuando hay mas de una-->
                                                <button class="btn btn-default" onclick="loadMatchModal('ubicacion','ubirefer', 'ubimapa', 1)" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div><!-- /input-group -->
                                    </div><!-- /.col-lg-6 -->
                                 <div class="col-lg4 col-sm-12" > </div> <nav></nav>
                                                <div class="input-group">                                                            
