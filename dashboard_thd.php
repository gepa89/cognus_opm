                            ...
                            <div class="modal-body">
                                <div class="form">
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="vlnEntrega" value="" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                                <div class="col-lg-12 col-sm-12 col-xs-12 form-group" id="tbl_cnt" style="display:none;">
                                    <input type="hidden" id="vlnHdnEntrega" >
                                        <table class="table table-bordered table-striped" id="smpl_tbl">
                                            <thead>
                                                <tr>
                                                    <th class="table_checkbox"><input id="select_rows_all" name="select_rows_all" class="select_rows" data-tableid="smpl_tbl" type="checkbox"></th>
                                                    <th>Posición</th>
                                                    <th>Material</th>
                                                    <th>Descripción</th>
                                                    <th>Cantidad</th>
...
//                                                var_dump($rx);
                                            ?>
                                            <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inTimeEntrega" value="<?php echo $rx['ct_empaque']?>" placeholder="Entrega">
                                        </div>
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inTimeCentro" value="" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                            </div>
...
//                                                var_dump($rx);
                                            ?>
                                            <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inEntrega" value="<?php echo $rx['ct_empaque']?>" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                            </div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etEntrega" value="<?php echo $lst_ent?>" placeholder="Entrega">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input type="number" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etCantidad" value="" placeholder="Cantidad">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Cliente</label>
                                        <input class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etCliente" type="text">
                                        <input  id="etCodCliente" type="hidden">
                                        <input  id="etEmpresa" type="hidden">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Localidad</label>
                                        <input class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etLocalidad" type="text">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Zona Envio</label>
                                        <input class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etZonaEnvio" type="text">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Transporte</label>
                                        <input class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTransporte" type="text">
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="previewEt" disabled="disabled" onclick="viewEtiqueta()" class="btn btn-primary"><i class="splashy-zoom"></i> Visa Previa</button>
                ...
                <div  class="modal fade bd-example-modal-lg" id="etTransfModal" tabindex="-1" role="dialog">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="formSep col-lg-12 col-sm-12 col-xs-12 form-group">                                            
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrEntrega" value="" placeholder="Entrega">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrTANSP" value="" placeholder="Transpore">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrCIUDAD" value="" placeholder="Ciudad">
                                    </div>
                                    <input id="etTrEntrega2" type="hidden">
                                    <input id="etTrLGORT" type="hidden">
                                    <input id="etTrRESLO" type="hidden">
                                    <input id="etTrEMP" type="hidden">
                                    <input id="etTrBUKRS" type="hidden">
                                    <input id="etTrLGOBE" type="hidden">                                    
                                    <input id="etTrBULKS" type="hidden">
                                </div>
                                <div style="clear:both;"></div>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="previewEtTr" disabled="disabled" onclick="viewEtiquetTra()" class="btn btn-primary"><i class="splashy-zoom"></i> Visa Previa</button>
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnEntrega" value="" placeholder="Entrega">
                                        <input type="hidden" id="mnNroManifiesto" value="">
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnChofer" value="" placeholder="Chofer">
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnChapa" value="" placeholder="Chapa">
                                    </div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnObs" value="" placeholder="Observación">
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">                                            
                                        <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="blEntrega" value="" placeholder="Entrega">
                                        <input type="hidden" id="blNroManifiesto" value="">
                                    </div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 form-group">                                            
                                        <ul class="blEntTbl ">
                                        </ul>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="previewBl" disabled="disabled" onclick="viewBoleta()" class="btn btn-primary"><i class="splashy-zoom"></i> Visa Previa</button>
