...
$sqlc = "SELECT cencod as id , CONCAT(cencod, '-', cendes) AS name
FROM centros";
$query = $db->query($sqlc);
$centros = $query->fetch_all(MYSQLI_ASSOC);

$sqla= "SELECT almcod as id , CONCAT(almcod, '-', almdes) AS name
FROM alma";
$query = $db->query($sqla);
$almacenes = $query->fetch_all(MYSQLI_ASSOC);
        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Creacion Pedidos al Proveedor</h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <select id="proveedor" name="proveedor" style="height: 40px !important;" required
              ...
              <!--   <div class="col-md-3">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    ...
                    <select id="grupocompra" required class="form-control">
                      <?php
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="form-group">
                    <label for="pedgen" style="color: #8B0000;">Total Pedido:</label>
                    <input id="pedgen" disabled name="pedgen" class="form-control" style="background-color: #d3d3d3;">
                  </div>
                </div>  
              </div>
            </div>
  ...
  <script>
    ...
    $(document).ready(function () {
      ...
      $('#form').submit(function (e) {
        ...
        $.ajax({
          type: 'POST',
          url: 'api/guardarPedProve.php',
          data: {
            proveedor: $("#proveedor").val(),
            moneda: $("#moneda").val(),
            codsocie: $("#codsocie").val(),
            orgcompra: $("#orgcompra").val(),
            grupocompra: $("#grupocompra").val(),
            crt: $("#crt").val(),
            factura: $("#factura").val(),
      ...
      //  let cantidad = spread.getValueFromCoords(pos + 2);  // Columna 1
      //  let costo = spread.getValueFromCoords(pos + 5);  // Columna 1
      //  let result = cantidad * costo;
        if (x == 0) {
          let pos = Number(x);
          $.ajax({
            ...
            success: function (data) {
             ...
             //   spread.setValueFromCoords(pos + 6, y, result);  // Columna 6 (índice 5)
      ...
      colWidths = [200, 400, 90, 80, 100, 80, 80, 60, 60, 60, 60, 60];
      ...
      var opciones = {
        ...
        columns: [
          ...
          {
            type: 'dropdown', source: centros
          },
          {
            type: 'dropdown', source: almacenes
          },
          /*{
        ...
        tableOverflow: true,
        colHeaders: ['Material', 'Descripción', 'Cantidad', 'UM', 'Ctdad.Presentacion', 'Prec.unit', 'Prec.Total', 'Vol.m3', 'Peso.B', 'Centro', 'Almacen'],
