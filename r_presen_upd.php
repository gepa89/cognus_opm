...
$ro = ",readOnly:true";
$fl = 1;
$sel = "select  artrefer, canpresen, preseref, cod_alma from artipresen";
$rs = $db->query($sel);
                    ...
                    <div class="col-md-12 col-lg-12 col-xs-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                <button type="button" id="sndBtn" onclick="descargarTabla()" class="form-control btn btn-primary">Exportar</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var rowdeleted = function(el, rowNumber, numOfRows) {
                ...
                var r = confirm(`Desea borrar la presentacion ${data[2]} del material ${data[0]}?`);
                if (r) {
                    $.ajax({
                        type: 'POST',
                        url: 'requests/eliminar_presentaciones.php',
                        data: {
                            material: data[0],
                            presentacion: data[2],
                            cod_alma: data[3]
            ...
            jexcel(document.getElementById('demo1'), {
                ...
                colHeaders: ['Material', 'Cant/Pres.', 'Presen', 'Almacen'],
