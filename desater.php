...
$ro = ",readOnly:true";
$fl = 1;
$sel = "select  tercod, pedido, id from assig_ped";
$rs = $db->query($sel);
...
<body class="full_width">
            ...
            <div class="main_content">
                <div class="row">
                    ...
                    echo '<table class="table">'
                        . '<thead>'
                        . '<tr>'
                        . '<th colspan="3">Anular asignacion de terminales.</th>'
                        . '</tr>'
                        . '</thead>'
                        . '</table>'; ?>
                    <div class="col-md-12 col-lg-12 col-xs-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group">
                                <button type="button" id="sndBtn" onclick="descargarTabla()"
                                    class="form-control btn btn-primary">Exportar</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            var spread = null;
            var beforedelete = function (instance, row) {
                let data = spread.getRowData(row);
                console.log(data);
                $.ajax({
                    type: 'POST',
                    url: 'api/eliminarAsignacionPedido.php',
                    data: {
                        id: data[2]
                        ...
                        Swal.fire({
                            title: 'Exito!!',
                            icon: 'success',
                            html: `<h3>Assignación Eliminada</h3>`,
            ...
            $('#repor7').addClass('active');
            $('#c6').click();
            spread = jexcel(document.getElementById('demo1'), {
                //                $('#demo1').jexcel({ 
                data: dex,
