...
<body class="full_width">
        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Crear Orden de Compra</h3>
            </div>
            <div class="panel-body">
              <div class="row">
                <div class="col-sm-2">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <input type="search" id="id_pedido_buscaro" class="form-control">
                      <span class="input-group-btn">
                        <button class="btn btn-primary" id="buscar_pedidoo" type="button"><span
                ...
                <div class="col-sm-2">
                  <div class="form-group">
                    <label for="proveedor">Nro.Contrato:</label>
                    <div class="input-group">
  ...
  <script>
    ...
    function buscarPedido(iDPedido) {
      $.ajax({
        type: 'GET',
        url: 'api/obtenerPedidoContratos.php',
        data: {
          id_pedido: iDPedido,
    ...
    $(document).ready(function () {
      ...
      var opciones = {
        ...
        tableOverflow: true,
        colHeaders: ['Material', 'Descripción', 'Cantidad', 'UM', 'Prec.unit', 'Prec.Total', 'Centro', 'Almacen', 'Contrato', 'Oferta'],
