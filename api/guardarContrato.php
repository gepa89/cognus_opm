...
require_once(__DIR__ . "/../api/helpers/helper_guardar_contrato_cab.php");
...
$id_pedido = guardar_contratos_cab($db, !empty($id_pedido), $proveedor, $documento, $moneda,$codsocie, $grupcompra, $orgcompra,$cencod, $cod_alma, $id_pedido, $detalles);
$db->close();
