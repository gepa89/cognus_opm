...
guardar_info_log("guardar articulo", json_encode($_POST));
...
//                        echo $sIn;
                        ...
                        guardar_movimiento_stock($db, $pedido, $material, $cantidad, $ubic, 'SAVE', $usuario, $hoy, $hoyhora, $cod_alma, $mrefAssi);
