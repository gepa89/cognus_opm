...
if ($buscar) {
    ...
    if (is_numeric($buscar)) {
        $filtros_busqueda .= " OR idpedflete LIKE '%$buscar%' ";
    }

    if (!is_numeric($buscar)) {
        $filtros_busqueda .= " OR pedclase LIKE '%$buscar%' OR ($sql_terminal) LIKE '%$buscar%' OR situped LIKE '%$buscar%'";
    }
...
$sql_condicion = " FROM
                    fletecab 
                    left join proveedores on fletecab.codprove = proveedores.codprove
                    where TRUE 
                    $filtro ";
...
$sql_datos = "
    ...
    fletecab.codliber
        ...
        $sql_condicion
        ORDER BY fletecab.idpedflete asc
        LIMIT ? OFFSET ?
";
//print $sql_datos;
