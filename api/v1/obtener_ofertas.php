...
if ($buscar) {
    ...
    if (is_numeric($buscar)) {
        $filtros_busqueda .= " OR idoferta LIKE '%$buscar%' ";
    }
...
$sql_condicion = " FROM
                    ...
                    inner join oferdet on ofercab.idoferta=oferdet.idoferta
                    where TRUE 
                    $filtro ";
...
$sql_datos = "
    ...
    ofercab.orgcompra,
    ofercab.grupcompra,
    SUM(oferdet.prectotal) as totalp,
    ofercab.codliber,
    ofercab.situped


        $sql_condicion
        GROUP BY ofercab.idoferta    
        ORDER BY ofercab.idoferta asc
        LIMIT ? OFFSET ?
";
//print $sql_datos;
