                                        ...
                                        <div class="form-horizontal">
                                            <div class="col-lg-12">
                                                <div class="form-group">                                                
                                                    <input type="text"  class="form-control" id="inputEntrega" placeholder="Entrega">
                                                </div>
                                            </div>
                                    ...
                                    <div class="sidebar_info2" style="width: 551px !important; margin:0 auto;">
                                        <ul class="list-unstyled">
                                            <li style="width: 30.108% !important; margin-right:15px !important;position:relative; display:inline-block !important;">
                                                <span id='lblPed' class="act act-success"></span>
                                                <strong>Pedidos</strong>
                                            </li>
                                            <li style="width: 30.108% !important; margin-right:15px !important;position:relative; display:inline-block !important;">
                                                <span id='lblMat' class="act act-success"></span>
                                            ...
                                            <li style="    border-bottom: 1px dashed #ccc;width: 30.108% !important; margin-right:15px !important;position:relative; display:inline-block !important;">
                                                <span id='lblCant' class="act act-success"></span>
...
//                                                var_dump($rx);
                                        ...
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            <input type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inTimeCentro" value="" placeholder="Expedición">
                                        </div>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="form">
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input type="text" class="col-lg-12 col-sm-12 youcol-xs-12 form-control" id="vlnEntrega" value="" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
