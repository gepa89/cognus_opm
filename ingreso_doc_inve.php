        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Creacion Documento Inventario por Material  </h3>
            </div>
    ...
    $(document).ready(function() {
      ...
      var changed = function(instance, cell, x, y, value) {
        ...
        if (x == 0) {
          ...
          let y_axis = Number(y);
          $.ajax({
            url: 'api/obtenerArticulosInventario.php',
            type: "GET",
            data: {
              cod_articulo: value,
              tipo: tipo
            ...
            success: function(data) {
              if (data.estado === "exito") {
                for (let i = 0; i < data.dato.length; i++) {
                  ...
                  spread.setValueFromCoords(pos, y_axis, element.artrefer);
                  ...
                  spread.setValueFromCoords(pos + 3, y_axis, element.ubirefer);
                  // setear precio
      ...
      var opciones = {
        ...
        tableOverflow: true,
        colHeaders: ['Material', 'Descripción', 'Stock', 'Ubicacion', 'Tipo'],
