...
<body class="full_width">
        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Consulta Pedidos de Entrada</h3>
            </div>
  ...
  <script>
    ...
    function buscarPedido(iDPedido) {
      $.ajax({
        type: 'GET',
        url: 'api/obtenerPedidoDocumentos.php',
        data: {
          id_pedido: iDPedido,
          ...
          if (data.estado === "exito") {
            ...
            $("#grupocompra").val(cabecera.grupcompra).trigger('change');
            $("#tipo").val(cabecera.tipo).trigger('change');
    ...
    $(document).ready(function () {
      ...
      colWidths = [200, 400, 90, 80, 80, 80, 80, 60, 60, 60, 60, 60];
      ...
      var opciones = {
        ...
        tableOverflow: true,
        colHeaders: ['Material', 'Descripción', 'Cantidad', 'UM', 'Presentacion', 'Prec.unit', 'Prec.Total', 'Vol.m3', 'Peso.B', 'Centro', 'Almacen'],
