...
if($leMat != ''){
    $ro = ",readOnly:true";
    $fl = 1;
    $sel = "select  artrefer, canpresen, preseref,cod_alma from artipresen where artrefer = '{$leMat}'";
    $rs = $db->query($sel);
                ...
                <div class="main_content">
                    ...
                    <?php
                        ...
                        echo '<table class="table">'
                            . '<thead>'
                                . '<tr>'
                                . '<th colspan="3">Definición de Presentación para artículos.</th>'
                                . '</tr>'
                            . '</thead>'
                        . '</table>';?>
