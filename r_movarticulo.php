                    ...
                    <div class="row">
                        <?php
                            ...
                            echo '<table class="table">'
                                . '<thead>'
                                    . '<tr>'
                                    . '<th colspan="3">Consulta de Movimientos de Artículos/<th>'
                                    . '</tr>'
                                . '</thead>'
                            . '</table>';?>
                                ...
                                <div class="col-lg-12 col-sm-12" ><br/>
                                    ...
                                    <div class="col-lg-2 col-sm-2" >
                                       <div class="input-group">
                                            ...
                                            <input class="form-control" id="cli" name="cli" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-2 col-sm-2" >
                                        <div class="input-group">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" id="prov" name="prov" />
                                            </div>
                                        </div>
                                    </div>
