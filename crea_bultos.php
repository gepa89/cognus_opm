...
<body class="full_width">
          ...
          <form id="form_filtros" method="get">
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">Administracion de Bultos</h3>
              </div>
            ...
            <div class="modal-body">
              <form method="post" id="eForm">
                 <div class="row">
                   <div class="col-sm-4">
                    <div class="form-group">
                      <label for="buscar">Bultos</label>
                      <input type="text" id="updBul" name="updBul" class="form-control"
              ...
              <form method="post" id="eForm">
                <div class="row">
                   <div class="col-sm-4">
                    <div class="form-group">
                      <label for="buscar">Bultos</label>
                      <input type="text" id="addBul" name="addBul" class="form-control"
                        placeholder="" value="" />
                    </div>
                  </div>
                     <div class="col-sm-7">
  ...
  <script type="text/javascript">
          ...
          
          {
            mRender: function (data, type, row) {
              let texto = `<a title="Modificar Material">
                                            <span style="font-size:14px" onclick="updDat('${row.tipbul}','${row.nombre}','${row.fecre}')" class="glyphicon glyphicon-pencil"></span></a>
    ...
    $(document).ready(function () {
      ...
      $('#c7').click();
      let url = 'requests/obtenerBultos.php';
      crearTabla(url);
      $("#form_filtros").submit(function (e) {
        e.preventDefault();
        let buscar = $("#buscar").val();
        let url = `requests/obtenerBultos.php?buscar=${buscar}`;
        if (table != null) {
          table.destroy();
          table = null;
        }
      ...
      if (Bul != '') {
        $.ajax({
          ...
          data: {
            ...
            alert(dt.msg);
            if (dt.err == 0) {
              window.location = 'crea_bultos.php';
            }
