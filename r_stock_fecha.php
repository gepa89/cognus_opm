...
<body class="full_width">
          ...
          <form id="form_filtros" method="get">
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">Consulta de Stock por Fecha</h3>
              </div>
                  ...
                  <div class="col-md-3 ">
                   ...
                   <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="dFecCre" value="<?php echo $hoy; ?>" name="dFecCre" type="date">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="buscar">Fecha Hasta:</label>
                                            <input class="form-control" id="hFecCre" value="<?php echo $hoy; ?>" name="hFecCre" type="date">
                                        </div>
                                    </div>  
                  <div class="col-md-3 ">
                    <div class="form-group">
  ...
  <script type="text/javascript">
    ...
    function ckFields() {
      ...
      params.set('dFecCre', dFecCre);
      params.set('hFecCre', hFecCre);
      let url = 'requests/getStockFecha.php' + '?' + params.toString();
      datatable(url);
    }
    function swOC(oc, pd) {
      $.ajax({
    ...
    function datatable(url) {
      if ($.fn.dataTable.isDataTable('#tblReg')) {
        ...
        table = $('#tblReg').DataTable({
          ...
          buttons: [],
          ajax: 'requests/getStockFecha.php',
          paging: true,
          processing: true,
          serverSide: true,
          searching: false,
    ...
    $(document).ready(function () {
      $('#repor66').addClass('active');
      $('#c9').click();
      datatable(null);
      $("#descargar_reporte").click(function (e) {
        location.href = 'requests/exportar_stock_fecha.php?' + params.toString();
