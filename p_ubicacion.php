                            ...
                            <div class="col-sm-12 col-md-12">
                                <form id="validate_wizard" class="stepy-wizzard form-horizontal form_validation_reg">
                                    <fieldset title="Creación de Ubicaciones">
                                        <legend class="hide">Seleccionar Almacen</legend>
                                    ...
                                    <fieldset title="Creación de Ubicaciones">
                                        ...
                                        <div class="formSep form-group">
                                            <label for="a_cod_alma" class="col-md-2 control-label">Código de
                                                Almacen:</label>
                                            <div class="col-md-10">
                                                <input type="text" name="a_cod_alma" id="a_cod_alma"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="formSep form-group">
                                            <label for="a_cod_estanteria" class="col-md-2 control-label">Código de
                                                Estantería:</label>
                                            <div class="col-md-10">
                                                <input type="text" name="a_cod_estanteria" id="a_cod_estanteria"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="formSep form-group">
                                            <label for="a_mod_estanteria" class="col-md-2 control-label">Modelo de
                                                Estantería:</label>
                                            <div class="col-md-10">
                                                <input type="text" name="a_mod_estanteria" id="a_mod_estanteria"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="a_c_desde" id="a_c_desde"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="a_c_hasta" id="a_c_hasta"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="a_nivel" id="a_nivel"
                                                    class="input-sm form-control">
                                            </div>
                                        </div>
                                    </fieldset>
                                    ...
                                    <button type="button" onclick="svLocation()" class="finish btn btn-primary"><i
                                            class="glyphicon glyphicon-ok"></i> Guardar</button>
                                </form>
                                <div class="col-md-12 col-lg-12 col-xs-12">
                                    ...
                                    <div id="accordion1" class="panel-group accordion">
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-heading">
                                                <a href="#collapseFour" data-parent="#accordion1" data-toggle="collapse"
    ...
    <script>
        ...
        function svLocation() {
            ...
            if (flg == 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'requests/saveLocation.php',
                    data: {
                        a_cod_alma: a_cod_alma,
        ...
        var beforeInsRow = function (instance, row) {
            ...
            if (c_desde != '' && n_desde != '' && c_hasta != '' && n_hasta != '' && zona != '') {
                ...
                if (error.includes(1)) {
                    alert('Rango inválido 1');
                    return false;
                } else {
                    console.log("seteando AL");
                    for (i = parseInt(c_desde); i <= parseInt(c_hasta); i++) {
                        for (j = parseInt(n_desde); j <= parseInt(n_hasta); j++) {
                            //                        console.log('#coord_alm_'+i+'_'+j + ' vale ' + $('#coord_alm_'+i+'_'+j).text());
                            switch (zona) {
        ...
        $(document).on("click", '#validate_wizard-next-1', function () {
