...
<body class="full_width">
            ...
            <div class="main_content">
                <div class="row">
                    ...
                    echo '<table class="table">'
                        . '<thead>'
                        . '<tr>'
                        . '<th colspan="3">Costo de Almacenamiento</th>'
                        . '</tr>'
                        . '</thead>'
                        . '</table>'; ?>
    ...
    <script type="text/javascript">
        ...
        function ckFields() {
            ...
            $.ajax({
                type: 'POST',
                url: 'requests/getCostoAlmacenamiento.php',
                async: false,
                data: {
                    desPed: desPed,
                    desPrv: desPrv,
        ...
        function format(d) {
            ...
            $.each(d, function (k, v) {
                ...
                cntnt += '<td>' + v.zoncodpre + '</td>';
                cntnt += '<td>' + v.canpedi + '</td>';
                cntnt += '<td>' + v.canprepa + '</td>';
                cntnt += '<td>' + v.canpendi + '</td>';
                cntnt += '<td>' + v.fecingre + '</td>';
                cntnt += '<td>' + v.diasalma + '</td>';
                cntnt += '<td>' + v.costoarticulo + '</td>';
        ...
        $(document).ready(function () {
            ...
            $('#costo_almacenamiento').addClass('active');
            $('#c9').click();
