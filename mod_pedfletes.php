...
<body class="full_width">
        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Modificar Pedido de Fletes</h3>
            </div>
  ...
  <script>
    ...
    function buscarPedido(iDPedido) {
      $.ajax({
        type: 'GET',
        url: 'api/obtenerPedidoFletes.php',
        data: {
          id_pedido: iDPedido,
          ...
          if (data.estado === "exito") {
            ...
            $("#clasflete").val(cabecera.pedclase);
            $("#puertcarga").val(cabecera.codpuertor);
            $("#incote").val(cabecera.incote);
            ...
            $("#pedgen").val(cabecera.idpedflete);
