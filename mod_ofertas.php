...
<body class="full_width">
        ...
        <form id="form" method="post">
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">Modificar Pedidos de ofertas</h3>
            </div>
  ...
  <script>
      ...
      $.ajax({
        ...
        data: {
          ...
          if (data.estado === "exito") {
            ...
            $("#documento").val(cabecera.pedclase);
            $("#cencod").val(cabecera.cencod);
            $("#almacen").val(cabecera.codalma).trigger('change');
           
           
            $("#pedgen").val(cabecera.idoferta);
            $("#stped").val(cabecera.situped);
    ...
    $(document).ready(function () {
      ...
      colWidths = [200, 400, 90, 80, 80, 60, 60, 60];
