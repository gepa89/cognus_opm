...
//if($leMat != ''){
    $ro = ",readOnly:true";
    $fl = 1;
    $sel = "select  artrefer, ubirefer, ubitipo, cod_alma, refid from artubiref ";
    $rs = $db->query($sel);
...
//                
                ...
                var r = confirm("¿Desea borrar "+data[0]+" de la ubicación "+data[1]+" tipo "+data[2]+"?");
                if(r){
                    $.ajax({ 
                        type: 'POST',
                        url: 'requests/delRefUbi.php', 
                        data:{
                            id:data[4]
                        },success: function (data) {
                            var dt = JSON.parse(data);
...
//                $('#demo1').jexcel({ 
                    ...
                    colHeaders: ['Material', 'Ubicación', 'Tipo', 'Almacen', 'Id'],
