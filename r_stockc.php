                    ...
                    <div class="row">
                        <?php
                            ...
                            echo '<table class="table">'
                                . '<thead>'
                                    . '<tr>'
                                    . '<th colspan="3">Stock por Clientes</th>'
                                    . '</tr>'
                                . '</thead>'
                            . '</table>';?>
...
<!--                                    <div class="col-lg-6 col-sm-6" >
                                    ...
                                    <div class="col-lg-3 col-sm-3">
                                        <label class="label">Cliente:</label><div style="clear:both;"></div><br/>
                                        <div class="input-group">                                            
...
<!--                                            <small>Para varios materiales, ingresar separados entre ','(comas)</small>-->
                                            <span class="input-group-btn">
                                                ...
                                                <button class="btn btn-default" onclick="loadMatchModal('cliente','clirefer,clinom', 'clientes', 1)" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div><!-- /input-group -->
                                    </div>
                                    <div class="input-group">                                                            
                    ...
                    <?php
                        ...
                        echo '<table class="table">'
                            ...
                            . '</thead>'
                        . '</table>';?>
                         <table class="table table-hover table-striped table-bordered dTableR" id="tblReg" style="font-size: 12px !important;">
                            <thead>
