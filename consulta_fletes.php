          ...
          <form id="form_filtros" method="get">
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">Consultar Contratacion de Fletes</h3>
              </div>
        ...
        table = $('#tblReg').DataTable({
          ...
          columns: [{
            ...
            },
            {
              ...
              className: 'dt-body-center',
              mRender: function(data, type, row) {
                let progrButton = `<li><a style="margin:0;padding:0" onclick="programarHorario('${row.idpedflete}')" href="javascript:void(0);">Sol.Aprobacion</a></li>`;
