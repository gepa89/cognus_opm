...
class adLDAP {
    ...
    const ADLDAP_SECURITY_LOCAL_GROUP = 536870912;//grupo local de seguridad
    ...
    * @var string
    */   
	protected $accountSuffix = "@chacomer.com.py";
    ...
    * @var string
    */
	protected $baseDn = "DC=chacomer,DC=com,DC=py"; 
    ...
    * @var array
    */
    protected $domainControllers = array("chacomer.com.py");
    ...
    */
    ...
    protected $adminPassword = 'Ch4c0Ch412013';
