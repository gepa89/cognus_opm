                        ...
                        <div class="col-lg-12 col-sm-12 col-xs-12">    
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                    <h3 class="heading">Situación de Empaque</h3>
                                    <div class="col-sm-12">
                                ...
                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                    ...
                                    <div class="col-sm-12">
                                        <div id="gr_4" style="height:180px;width:100%;"></div>
                                    </div>
                                    <h3 class="heading">Transferencias</h3>
                                    <div class="col-sm-12">
                                        <div id="gr_5" style="height:180px;width:100%;"></div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4 col-xs-12">
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        <h3 class="heading">Control de Entrega</h3>
                                        <div class=" col-lg-12 col-sm-12 col-xs-12">
                                            <?php // var_dump($_SESSION);?>
                                            <div class="form-horizontal">
                                                <div class="col-lg-12">
                                                    <div class="form-group">                                                
                                                        <input autocomplete="on" autocomplete="on" type="text"  class="form-control" id="inputEntrega" placeholder="Entrega">
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-lg-12 col-sm-12 col-xs-12">
                                        ...
                                        <ul class="dshb_icoNav clearfix">
                                            ...
                                            <li><a href="javascript:void(0)" onclick="swModal('manifiestoModal')" style="background-image: url(img/gCons/van.png)"> Manifiesto</a></li>
                                            <li><a href="javascript:void(0)" onclick="swModal('boletaModal')" style="background-image: url(img/gCons/addressbook.png)"> Boletas</a></li>
                                        ...
                                        <li><a href="javascript:void(0)" onclick="swModal('closeBoxModal')" style="background-image: url(img/gCons/connected.png);"> Bultos</a></li>
                                            ...
                                            <li><a href="c_usuarios.php" style="background-image: url(img/gCons/agent.png);"> Usuarios</a></li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body">
                                <div class="form">
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            ...
                                            <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="vlnEntrega" value="" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                                <div class="col-lg-12 col-sm-12 col-xs-12 form-group" id="tbl_cnt" style="display:none;">
                                    <input autocomplete="on" autocomplete="on" type="hidden" id="vlnHdnEntrega" >
                                        <table class="table table-bordered table-striped" id="smpl_tbl">
                                            <thead>
                                                <tr>
                                                    <th class="table_checkbox"><input autocomplete="on" autocomplete="on" id="select_rows_all" name="select_rows_all" class="select_rows" data-tableid="smpl_tbl" type="checkbox"></th>
                                                    <th>Posición</th>
                                                    <th>Material</th>
                                                    <th>Descripción</th>
                                                    <th>Cantidad</th>
...
//                                                var_dump($rx);
                                            ?>
                                            <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inTimeEntrega" value="<?php echo $rx['ct_empaque']?>" placeholder="Entrega">
                                        </div>
                                        <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                            <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inTimeCentro" value="" placeholder="Expedición">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                            </div>
...
//                                                var_dump($rx);
                                            ?>
                                            <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="inEntrega" value="<?php echo $rx['ct_empaque']?>" placeholder="Entrega">
                                        </div>
                                </div>
                                <div style="clear:both;"></div>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etEntrega" value="<?php echo $lst_ent?>" placeholder="Entrega">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="number" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etCantidad" value="" placeholder="Cantidad">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Cliente</label>
                                        <input autocomplete="on" autocomplete="on" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etCliente" type="text">
                                        <input autocomplete="on" autocomplete="on"  id="etCodCliente" type="hidden">
                                        <input autocomplete="on" autocomplete="on"  id="etEmpresa" type="hidden">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Localidad</label>
                                        <input autocomplete="on" autocomplete="on" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etLocalidad" type="text">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Zona Envio</label>
                                        <input autocomplete="on" autocomplete="on" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etZonaEnvio" type="text">
                                    </div>
                                    <div class="formSep col-sm-6 col-md-6 col-xs-12">
                                        <label>Transporte</label>
                                        <input autocomplete="on" autocomplete="on" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTransporte" type="text">
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrEntrega" value="" placeholder="Entrega">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrCant" value="" placeholder="Cantidad">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrTANSP" value="" placeholder="Transpore">
                                    </div>
                                    <div class="formSep col-lg-6 col-sm-6 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="etTrCIUDAD" value="" placeholder="Ciudad">
                                    </div>
                                    <input autocomplete="on" autocomplete="on" id="etTrEntrega2" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrCant2" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrLGORT" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrRESLO" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrEMP" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrBUKRS" type="hidden">
                                    <input autocomplete="on" autocomplete="on" id="etTrLGOBE" type="hidden">                                    
                                    <input autocomplete="on" autocomplete="on" id="etTrBULKS" type="hidden">
                                </div>
                                <div style="clear:both;"></div>
                        ...
                        <div class="modal-body">
                            <div class="form">
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                            <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="btTransf" placeholder="Transferencia">
                                    </div>
                            </div>
                            <div style="clear:both;"></div>
                            <div id="btContents">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnEntrega" value="" placeholder="Entrega">
                                        <input autocomplete="on" autocomplete="on" type="hidden" id="mnNroManifiesto" value="">
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnChofer" value="" placeholder="Chofer">
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnChapa" value="" placeholder="Chapa">
                                    </div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 form-group">
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="mnObs" value="" placeholder="Observación">
                                    </div>
                                </div>
                                <div style="clear:both;"></div>
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form">
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="blEntrega" value="" placeholder="Entrega">
                                        <input autocomplete="on" autocomplete="on" type="hidden" id="blNroManifiesto" value="">
                                    </div>
                                    <div style="clear:both;"></div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="blTransporte" value="" placeholder="Transporte">
                                    </div>
                                    <div class="col-lg-4 col-sm-4 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="blChapa" value="" placeholder="Chapa">
                                    </div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 form-group">                                            
                                        <input autocomplete="on" autocomplete="on" type="text" class="col-lg-12 col-sm-12 col-xs-12 form-control" id="blObs" value="" placeholder="Observación">
                                    </div>
                                    <div class="col-lg-12 col-sm-12 col-xs-12 form-group">                                            
                                        <ul class="blEntTbl ">
                                        </ul>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" id="svBl" onclick="btnSvBoleta()" disabled="disabled" class="btn btn-primary">Guardar</button>
