            ...
            <table class="table table-hover table-striped table-bordered dTableR" id="tbl_list"
              ...
              <tbody>
                ...
                $sq = "SELECT * FROM usuarios
                        LEFT JOIN roles on roles.id=usuarios.pr_rol";
                //                                            echo $sq;
                $rs = $db->query($sq);
                while ($row = $rs->fetch_assoc()) {
                  ...
                  echo "<td>" . '<a title="Modificar" onclick="updUSR(' . "'" . $row['pr_user'] . "'" . ",'" . $row['pr_nombre'] . "'" . ",'" . $row['pr_apellido'] . "'" . ",'" . $row['clirefer'] . "'" . ",'" . $row['pr_email'] . "'" . ",'" . $row['rolrefer'] . "'" . "" . ')"><span style="font-size:14px" class="glyphicon glyphicon-pencil"></span></a>' . "</td>";
                  echo "</tr>";
                }
                ?>
              </tbody>
                  ...
                  <div class="input-group">
                    ...
                    <select class="form-control" id="rol" name="rol">
                      ...
                      while ($ax = $rs->fetch_object()) {
                        echo "<option value='{$ax->id}'>{$ax->nombre}</option>";
