...
<body class="full_width">
          ...
          <form id="form_filtros" method="get">
            <div class="panel panel-info">
              <div class="panel-heading">
                <h3 class="panel-title">Administracion de Fleteros</h3>
              </div>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12">
            ...
            echo '<table class="table">'
              . '<thead>'
              . '<tr>'
              . '<th colspan="2">Agregar Fleteros</th>'
              . '</tr>'
              . '</thead>'
              . '</table>';
            ...
            <div class="modal-body">
              <form method="post" id="eForm">
                 <div class="row">
                   <div class="col-sm-4">
                    <div class="form-group">
                      <label for="buscar">Fletero</label>
                      <input type="text" id="updFle" name="updFle" class="form-control"
              ...
              <form method="post" id="eForm">
                <div class="row">
                   <div class="col-sm-4">
                    <div class="form-group">
                      <label for="buscar">Fletero</label>
                      <input type="text" id="addFle" name="addFle" class="form-control"
                        placeholder="" value="" />
                    </div>
                  </div>
                     <div class="col-sm-7">
  ...
  <script type="text/javascript">
          ...
          
          {
            mRender: function (data, type, row) {
              let texto = `<a title="Modificar Material">
                                            <span style="font-size:14px" onclick="updDat('${row.codflete}','${row.nombre}','${row.fecre}')" class="glyphicon glyphicon-pencil"></span></a>
                                         <a title="Eliminar Bultos">
                                            <span style="font-size:14px" onclick="eliminarBultos('${row.codflete}')" class="glyphicon glyphicon-trash"></span></a>`;
              return texto;
            }
          }
        ],
    ...
    $(document).ready(function () {
      $('#para42').addClass('active');
      $('#c7').click();
      let url = 'requests/obtenerFleteros.php';
      crearTabla(url);
      $("#form_filtros").submit(function (e) {
        e.preventDefault();
        let buscar = $("#buscar").val();
        let url = `requests/obtenerFleteros.php?buscar=${buscar}`;
        if (table != null) {
          table.destroy();
          table = null;
        }
      ...
      if (Fle != '') {
        $.ajax({
          ...
          data: {
            ...
            table: 'fleteros',
            fields: 'codflete,nombre'
          }, success: function (data) {
            var dt = JSON.parse(data);
            alert(dt.msg);
            if (dt.err == 0) {
              window.location = 'crea_fletero.php';
            }
